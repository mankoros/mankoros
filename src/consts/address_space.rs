...
// 共享内存段 (128 GiB)
register_const!(U_SEG_SHARE_BEG, usize, 0x0000_0004_0000_0000);
register_const!(U_SEG_SHARE_END, usize, 0x0000_0006_0000_0000);

register_const!(U_SEG_END, usize, 0x0000_0006_0000_0000);
